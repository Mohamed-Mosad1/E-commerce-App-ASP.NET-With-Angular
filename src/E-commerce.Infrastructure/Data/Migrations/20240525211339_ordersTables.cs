        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Product_ProductItemId = table.Column<int>(type: "int", nullable: true),
                    Product_ProductItemName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 20m, null, "Fastest Delivery time", "DHL" },
                    { 2, 10m, null, "Get it with 3 days", "Aramex" },
                    { 3, 5m, null, "Slower but cheap", "Fedex" },
                    { 4, 0m, null, "Free", "Jumia" }
                });
